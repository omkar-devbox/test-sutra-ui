...
interface PaperTypeDeleteModalProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
...
export const PaperTypeDeleteModal: React.FC<PaperTypeDeleteModalProps> = ({
  isOpen,
  onClose,
  onConfirm,
  paperType,
      ...
      <ModalBody className="py-6 flex items-start gap-4">
        ...
        <div className="flex flex-col gap-1">
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400">
            This action cannot be undone. This paper type record will be permanently removed.
          </p>
        </div>
      </ModalBody>
